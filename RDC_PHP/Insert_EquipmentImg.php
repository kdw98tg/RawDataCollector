...
$file_name =$_SERVER['DOCUMENT_ROOT']."/RDC/Profile/EquipmentProfile";//업로드된 파일의 이름을 가져옴
...
$query ="UPDATE equipment SET equipment_image = '$serverDir' WHERE equipment_code = '$equipmentCode'";
//echo $query;
