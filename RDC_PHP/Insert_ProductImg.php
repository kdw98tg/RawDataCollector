...
$file_name =$_SERVER['DOCUMENT_ROOT']."/RDC/Profile/ProductProfile";//업로드된 파일의 이름을 가져옴
...
$query ="UPDATE product SET product_image = '$serverDir' WHERE product_code = '$productCode'";
//echo $query;
